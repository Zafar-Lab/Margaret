...
def run_metti(
    ...
    connectivity, scores = compute_directed_cluster_connectivity(communities, adj_conn, threshold=threshold)
    un_connectivity, un_scores = compute_undirected_cluster_connectivity(communities, adj_conn, threshold=threshold)
...
def run_metti_v2(
    ...
    g_undirected, node_positions = compute_connectivity_graph(ad.obsm['metric_viz_embedding'], communities, un_connectivity, mode='undirected')
